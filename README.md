...
### filter_and_subtract_all_sets()   is used for image processing to acquire displacement maps
  - filtering and combining
  - unwrapping
  - displacement map calculations
### compute_strain_xx()              is used for strain map calculation from displacement maps
